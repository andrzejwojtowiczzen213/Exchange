            ...
            {showTokenOnTop ? (
              <>
                ...
                <div style={secondaryDisplayStyles} onClick={handleToggle}>
                  ...
                  >
                    <path d="M3.25 7.75L7.25 3.75L11.25 7.75M12.75 16.25L16.75 20.25L20.75 16.25M7.25 5V20.25M16.75 3.75V19.25" stroke="#6B7280" strokeWidth="2.2" strokeLinecap="square"/>
                  </svg>
                </div>
              </>
            ) : (
          ...
          >
            <div style={buttonContentStyles}>
              {selectedCurrency === 'EUR' ? (
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 57 57" fill="none">
                  <defs>
                    <clipPath id="circle-mask-button">
                      <circle cx="28.5" cy="28.5" r="28.5" />
                    </clipPath>
                  </defs>
                  <circle cx="28.5" cy="28.5" r="28.5" fill="white"/>
                  <g clipPath="url(#circle-mask-button)">
